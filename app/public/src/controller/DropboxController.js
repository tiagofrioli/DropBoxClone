class DropboxController{
    ...
    constructor(){
        ...
        this.inputFilesEl = document.querySelector('#files'); //id do input files
        this.snackModalEl = document.querySelector('#react-snackbar-root'); // modal do files
    ...
    connectFirebase(){
        ...
        var firebaseConfig = {
            apiKey: "AIzaSyBlVNf-kG8JZaAXZhfxPSk1rEUDKd4Nl54",
            authDomain: "dropbox-clone-644c0.firebaseapp.com",
            databaseURL: "https://dropbox-clone-644c0.firebaseio.com",
            projectId: "dropbox-clone-644c0",
            storageBucket: "gs://dropbox-clone-644c0.appspot.com/",
            messagingSenderId: "981837694566",
            appId: "1:981837694566:web:f734ab075937784a914fa7"
        };
        // Initialize Firebase
    ...
    initEvents(){
        ...
        // evento click botão enviar arquivos
    ...
    ajax(url, method = 'GET', formData = new FormData(), onprogress = function(){}, onloadstart = function(){}){
        ...
        return new Promise((resolve, reject)=>{
            ...
            let ajax = new XMLHttpRequest();
                ...
                ajax.open(method, url);  // abre uma conexão via post para pasta upload
                
                ajax.onload = event => { // evento termino do envio do file
                ...
                // barra de progrosse upload file
    ...
    // metodo para receber os arquivos para upload
    uploadTask(files){ // coleção de dados / não array 
        ...
        [...files].forEach(file => { // coleção de array com spread
            ...
            /* Promessa com ajax que retorna apenas a referencia do arquivo via Firebase
            let formData = new FormData();
    ...
    getFileIconView(file){
        ...
        switch (file.type){
            ...
            <g fill="none" fill-rule="evenodd" data-darkreader-inline-fill="" style="--darkreader-inline-fill:none;">
            <g>
            <use fill="#000" filter="url(#mc-content-unknown-large-a)" xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#mc-content-unknown-large-b" data-darkreader-inline-fill="" style="--darkreader-inline-fill:#000000;"></use>
            <use fill="#F7F9FA" xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#mc-content-unknown-large-b" data-darkreader-inline-fill="" style="--darkreader-inline-fill:#151e22;"></use>
            </g>
            </g>
            </svg>`;
            break;
            ...
            c-2.209,0-4-1.791-4-4V34C43,31.791,44.791,30,47,30z" data-darkreader-inline-fill="" style="--darkreader-inline-fill:#151e22;"></path>
            </g>
            </g>
            </g>
            <g>
            ...
            c-0.003,0.878,0.268,1.03,1.069,1.027C66.443,97.898,73.779,97.911,81.115,97.911z" data-darkreader-inline-fill="" style="--darkreader-inline-fill:#3b3f42;"></path>
            ...
            c-2.487-4.379-6.362-7.275-10.562-9.819C78.656,85.579,78.257,85.345,77.737,85.036z" data-darkreader-inline-fill="" style="--darkreader-inline-fill:#bab5ab;"></path>
            ...
            c-0.001-0.497-0.042-0.847,0.693-0.839c6.389,0.065,12.483,1.296,18.093,4.476C81.915,90.33,84.829,92.695,87.313,95.973z" data-darkreader-inline-fill="" style="--darkreader-inline-fill:#bab5ab;"></path>
            <path fill-rule="evenodd" clip-rule="evenodd" fill="#848484" d="M74.188,76.557c0.01,2.266-1.932,4.223-4.221,4.255
            c-2.309,0.033-4.344-1.984-4.313-4.276c0.03-2.263,2.016-4.213,4.281-4.206C72.207,72.338,74.179,74.298,74.188,76.557z" data-darkreader-inline-fill="" style="--darkreader-inline-fill:#bab5ab;"></path>
            </g>
            </svg>`;
            break;
            
            case 'application/pfd':
            return 
            ` <svg version="1.1" id="Camada_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="160px" height="160px" viewBox="0 0 160 160" enable-background="new 0 0 160 160" xml:space="preserve">
            <filter height="102%" width="101.4%" id="mc-content-unknown-large-a" filterUnits="objectBoundingBox" y="-.5%" x="-.7%">
            <feOffset result="shadowOffsetOuter1" in="SourceAlpha" dy="1"></feOffset>
            ...
            c-0.131-1.296,1.072-0.867,1.753-0.876c0.796-0.011,1.668,0.118,1.588,1.293C97.394,93.857,97.226,94.871,96.229,94.8z" data-darkreader-inline-fill="" style="--darkreader-inline-fill:#ab2e0b;"></path>
            </svg>`;
            ...
            <g fill="none" fill-rule="evenodd" data-darkreader-inline-fill="" style="--darkreader-inline-fill:none;">
            <g>
            <use fill="#000" filter="url(#mc-content-video-large-a)" xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#mc-content-video-large-b" data-darkreader-inline-fill="" style="--darkreader-inline-fill:#000000;"></use>
            <use fill="#F7F9FA" xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#mc-content-video-large-b" data-darkreader-inline-fill="" style="--darkreader-inline-fill:#151e22;"></use>
            </g>
            <path d="M69 67.991c0-1.1.808-1.587 1.794-1.094l24.412 12.206c.99.495.986 1.3 0 1.794L70.794 93.103c-.99.495-1.794-.003-1.794-1.094V67.99z" fill="#637282" data-darkreader-inline-fill="" style="--darkreader-inline-fill:#bcb7ad;"></path>
            </g>
            </svg>`;
            break;
        }
    ...
    // metodo para tratar tipo do arquivo
        ...
        for(let i=0; i < this.currentFolder.length; i++){
            ...
            if((i+1) === this.currentFolder.length){
                ...
                <svg width="24" height="24" viewBox="0 0 24 24" class="mc-icon-template-stateless" style="top: 4px; position: relative;">
                    ...
                    <path d="M10.414 7.05l4.95 4.95-4.95 4.95L9 15.534 12.536 12 9 8.464z" fill="#637282" fill-rule="evenodd" data-darkreader-inline-fill="" style="--darkreader-inline-fill:#bcb7ad;"></path>
                    </svg>
                </span>
    ...
    // metodo para selecionar arquivo clicado
    initEventsli(li){
